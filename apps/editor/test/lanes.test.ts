...
describe("opening and closing", () => {
  ...
  it("the buffer follows the document: reload() reads the spec at the caret, and watch() wires it to the host's mirrors", () => {
    ...
    const document = createStore<{ id: string; version: number; measureCount: number; staffCount: number; title: string; tempo: number | null } | null>(null);
    ...
    document.set({ id: "d", version: 2, measureCount: 1, staffCount: 1, title: "", tempo: null });
